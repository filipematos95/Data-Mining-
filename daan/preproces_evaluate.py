...
"""
File reads in data by chunks to make an evaluation dataset.
"""
...
search_ids = []
    ...
    # orange row
    meta1 = ['d','d','c','c','d','d','c','c','c','c','c','d','d','d'] # discrete (d), continuous (c), string (s)
    meta2 = ['d','c','d','c','c','c','c','c','d','c','c']    
    meta4 = ['c','c','c','c','c'] 
